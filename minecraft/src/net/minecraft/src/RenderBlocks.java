...
public class RenderBlocks {
	...
	public boolean func_31074_b(Block uu1, int i1, int j1, int k1, boolean flag) {
		...
		if(flag1) {
			...
			case 0:
				...
				break;
			case 1:
				uu1.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 12.0F / 16.0F, 1.0F);
				break;
			case 2:
			...
			case 3:
				...
				uu1.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 12.0F / 16.0F);
				break;
			case 4:
			...
			case 5:
				...
				uu1.setBlockBounds(0.0F, 0.0F, 0.0F, 12.0F / 16.0F, 1.0F, 1.0F);
			}
	...
	public boolean func_31080_c(Block uu1, int i1, int j1, int k1, boolean flag) {
		...
		case 0:
			...
			this.renderStandardBlock(uu1, i1, j1, k1);
			this.func_31076_a((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 + 0.25F), (double)((float)j1 + 0.25F + f2), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1 * 0.8F, d1);
			this.func_31076_a((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 + 0.25F), (double)((float)j1 + 0.25F + f2), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.8F, d1);
			this.func_31076_a((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 + 0.25F), (double)((float)j1 + 0.25F + f2), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1 * 0.6F, d1);
			this.func_31076_a((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 + 0.25F), (double)((float)j1 + 0.25F + f2), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.6F, d1);
			break;
		case 1:
			uu1.setBlockBounds(0.0F, 12.0F / 16.0F, 0.0F, 1.0F, 1.0F, 1.0F);
			this.renderStandardBlock(uu1, i1, j1, k1);
			this.func_31076_a((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 - 0.25F + 1.0F - f2), (double)((float)j1 - 0.25F + 1.0F), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1 * 0.8F, d1);
			this.func_31076_a((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 - 0.25F + 1.0F - f2), (double)((float)j1 - 0.25F + 1.0F), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.8F, d1);
			this.func_31076_a((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 - 0.25F + 1.0F - f2), (double)((float)j1 - 0.25F + 1.0F), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1 * 0.6F, d1);
			this.func_31076_a((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 - 0.25F + 1.0F - f2), (double)((float)j1 - 0.25F + 1.0F), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.6F, d1);
			break;
		case 2:
			this.field_31085_i = 1;
			this.field_31084_j = 2;
			...
			this.renderStandardBlock(uu1, i1, j1, k1);
			this.func_31081_b((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 + 0.25F), (double)((float)k1 + 0.25F + f2), f1 * 0.6F, d1);
			this.func_31081_b((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 + 0.25F), (double)((float)k1 + 0.25F + f2), f1 * 0.6F, d1);
			this.func_31081_b((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 + 0.25F), (double)((float)k1 + 0.25F + f2), f1 * 0.5F, d1);
			this.func_31081_b((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 + 0.25F), (double)((float)k1 + 0.25F + f2), f1, d1);
			break;
		case 3:
			this.field_31085_i = 2;
			this.field_31084_j = 1;
			this.field_31083_k = 3;
			this.field_31082_l = 3;
			uu1.setBlockBounds(0.0F, 0.0F, 12.0F / 16.0F, 1.0F, 1.0F, 1.0F);
			this.renderStandardBlock(uu1, i1, j1, k1);
			this.func_31081_b((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 - 0.25F + 1.0F - f2), (double)((float)k1 - 0.25F + 1.0F), f1 * 0.6F, d1);
			this.func_31081_b((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 - 0.25F + 1.0F - f2), (double)((float)k1 - 0.25F + 1.0F), f1 * 0.6F, d1);
			this.func_31081_b((double)((float)i1 + 6.0F / 16.0F), (double)((float)i1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 - 0.25F + 1.0F - f2), (double)((float)k1 - 0.25F + 1.0F), f1 * 0.5F, d1);
			this.func_31081_b((double)((float)i1 + 10.0F / 16.0F), (double)((float)i1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 - 0.25F + 1.0F - f2), (double)((float)k1 - 0.25F + 1.0F), f1, d1);
			break;
		case 4:
			this.field_31087_g = 1;
			this.field_31086_h = 2;
			...
			this.renderStandardBlock(uu1, i1, j1, k1);
			this.func_31077_c((double)((float)i1 + 0.25F), (double)((float)i1 + 0.25F + f2), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.5F, d1);
			this.func_31077_c((double)((float)i1 + 0.25F), (double)((float)i1 + 0.25F + f2), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1, d1);
			this.func_31077_c((double)((float)i1 + 0.25F), (double)((float)i1 + 0.25F + f2), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.6F, d1);
			this.func_31077_c((double)((float)i1 + 0.25F), (double)((float)i1 + 0.25F + f2), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1 * 0.6F, d1);
			break;
		case 5:
			this.field_31087_g = 2;
			this.field_31086_h = 1;
			this.field_31083_k = 1;
			this.field_31082_l = 2;
			uu1.setBlockBounds(12.0F / 16.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
			this.renderStandardBlock(uu1, i1, j1, k1);
			this.func_31077_c((double)((float)i1 - 0.25F + 1.0F - f2), (double)((float)i1 - 0.25F + 1.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.5F, d1);
			this.func_31077_c((double)((float)i1 - 0.25F + 1.0F - f2), (double)((float)i1 - 0.25F + 1.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1, d1);
			this.func_31077_c((double)((float)i1 - 0.25F + 1.0F - f2), (double)((float)i1 - 0.25F + 1.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), (double)((float)k1 + 6.0F / 16.0F), f1 * 0.6F, d1);
			this.func_31077_c((double)((float)i1 - 0.25F + 1.0F - f2), (double)((float)i1 - 0.25F + 1.0F), (double)((float)j1 + 10.0F / 16.0F), (double)((float)j1 + 6.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), (double)((float)k1 + 10.0F / 16.0F), f1 * 0.6F, d1);
		}
	...
	public boolean renderBlockLever(Block uu1, int i1, int j1, int k1) {
		...
		float f9 = 1.0F / 16.0F;
		float f10 = 1.0F / 16.0F;
		float f11 = 10.0F / 16.0F;
		...
		for(int bt1 = 0; bt1 < 8; ++bt1) {
			...
			if(i2 < 5) {
				...
				abt[bt1].xCoord += (double)i1 + 0.5D;
				abt[bt1].yCoord += (double)((float)j1 + 2.0F / 16.0F);
				abt[bt1].zCoord += (double)k1 + 0.5D;
			}
		}
		...
		for(int j3 = 0; j3 < 6; ++j3) {
			...
			nw1.addVertexWithUV(var30.xCoord, var30.yCoord, var30.zCoord, (double)f5, (double)f8);
	...
	public boolean renderBlockFire(Block uu1, int i1, int j1, int k1) {
		...
		if(!this.blockAccess.isBlockNormalCube(i1, j1 - 1, k1) && !Block.fire.canBlockCatchFire(this.blockAccess, i1, j1 - 1, k1)) {
			...
			if(Block.fire.canBlockCatchFire(this.blockAccess, i1 - 1, j1, k1)) {
				nw1.addVertexWithUV((double)((float)i1 + var46), (double)((float)j1 + f2 + f5), (double)(k1 + 1), d3, d5);
				...
				nw1.addVertexWithUV((double)((float)i1 + var46), (double)((float)j1 + f2 + f5), (double)(k1 + 0), d1, d5);
				nw1.addVertexWithUV((double)((float)i1 + var46), (double)((float)j1 + f2 + f5), (double)(k1 + 0), d1, d5);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 0) + f5), (double)(k1 + 0), d1, d7);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 0) + f5), (double)(k1 + 1), d3, d7);
				nw1.addVertexWithUV((double)((float)i1 + var46), (double)((float)j1 + f2 + f5), (double)(k1 + 1), d3, d5);
			...
			if(Block.fire.canBlockCatchFire(this.blockAccess, i1 + 1, j1, k1)) {
				nw1.addVertexWithUV((double)((float)(i1 + 1) - var46), (double)((float)j1 + f2 + f5), (double)(k1 + 0), d1, d5);
				...
				nw1.addVertexWithUV((double)((float)(i1 + 1) - var46), (double)((float)j1 + f2 + f5), (double)(k1 + 1), d3, d5);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - var46), (double)((float)j1 + f2 + f5), (double)(k1 + 1), d3, d5);
				nw1.addVertexWithUV((double)(i1 + 1 - 0), (double)((float)(j1 + 0) + f5), (double)(k1 + 1), d3, d7);
				nw1.addVertexWithUV((double)(i1 + 1 - 0), (double)((float)(j1 + 0) + f5), (double)(k1 + 0), d1, d7);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - var46), (double)((float)j1 + f2 + f5), (double)(k1 + 0), d1, d5);
			...
			if(Block.fire.canBlockCatchFire(this.blockAccess, i1, j1, k1 - 1)) {
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)j1 + f2 + f5), (double)((float)k1 + var46), d3, d5);
				...
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)j1 + f2 + f5), (double)((float)k1 + var46), d1, d5);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)j1 + f2 + f5), (double)((float)k1 + var46), d1, d5);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)(j1 + 0) + f5), (double)(k1 + 0), d1, d7);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 0) + f5), (double)(k1 + 0), d3, d7);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)j1 + f2 + f5), (double)((float)k1 + var46), d3, d5);
			...
			if(Block.fire.canBlockCatchFire(this.blockAccess, i1, j1, k1 + 1)) {
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)j1 + f2 + f5), (double)((float)(k1 + 1) - var46), d1, d5);
				...
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)j1 + f2 + f5), (double)((float)(k1 + 1) - var46), d3, d5);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)j1 + f2 + f5), (double)((float)(k1 + 1) - var46), d3, d5);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 0) + f5), (double)(k1 + 1 - 0), d3, d7);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)(j1 + 0) + f5), (double)(k1 + 1 - 0), d1, d7);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)j1 + f2 + f5), (double)((float)(k1 + 1) - var46), d1, d5);
	...
	public boolean renderBlockRedstoneWire(Block uu1, int i1, int j1, int k1) {
		...
		if(byte0 == 0) {
			...
			nw1.setColorOpaque_F(f1, f1, f1);
			nw1.addVertexWithUV((double)f7, (double)((float)j1 + 0.015625F), (double)f9, d3, d7 + 1.0D / 16.0D);
			nw1.addVertexWithUV((double)f7, (double)((float)j1 + 0.015625F), (double)f8, d3, d5 + 1.0D / 16.0D);
			nw1.addVertexWithUV((double)f6, (double)((float)j1 + 0.015625F), (double)f8, d1, d5 + 1.0D / 16.0D);
			nw1.addVertexWithUV((double)f6, (double)((float)j1 + 0.015625F), (double)f9, d1, d7 + 1.0D / 16.0D);
		} else if(byte0 == 1) {
			nw1.addVertexWithUV((double)f7, (double)((float)j1 + 0.015625F), (double)f9, d3, d7);
			nw1.addVertexWithUV((double)f7, (double)((float)j1 + 0.015625F), (double)f8, d3, d5);
			nw1.addVertexWithUV((double)f6, (double)((float)j1 + 0.015625F), (double)f8, d1, d5);
			...
			nw1.setColorOpaque_F(f1, f1, f1);
			nw1.addVertexWithUV((double)f7, (double)((float)j1 + 0.015625F), (double)f9, d3, d7 + 1.0D / 16.0D);
			nw1.addVertexWithUV((double)f7, (double)((float)j1 + 0.015625F), (double)f8, d1, d7 + 1.0D / 16.0D);
			nw1.addVertexWithUV((double)f6, (double)((float)j1 + 0.015625F), (double)f8, d1, d5 + 1.0D / 16.0D);
			nw1.addVertexWithUV((double)f6, (double)((float)j1 + 0.015625F), (double)f9, d3, d5 + 1.0D / 16.0D);
		}
		...
		if(!this.blockAccess.isBlockNormalCube(i1, j1 + 1, k1)) {
			...
			if(this.blockAccess.isBlockNormalCube(i1 - 1, j1, k1) && this.blockAccess.getBlockId(i1 - 1, j1 + 1, k1) == Block.redstoneWire.blockID) {
				nw1.setColorOpaque_F(f1 * f3, f1 * f4, f1 * f5);
				nw1.addVertexWithUV((double)((float)i1 + 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 1), d4, d6);
				...
				nw1.addVertexWithUV((double)((float)i1 + 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 0), d4, d8);
				nw1.setColorOpaque_F(f1, f1, f1);
				nw1.addVertexWithUV((double)((float)i1 + 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 1), d4, d6 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)((float)i1 + 0.015625F), (double)(j1 + 0), (double)(k1 + 1), d2, d6 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)((float)i1 + 0.015625F), (double)(j1 + 0), (double)(k1 + 0), d2, d8 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)((float)i1 + 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 0), d4, d8 + 1.0D / 16.0D);
			}

			if(this.blockAccess.isBlockNormalCube(i1 + 1, j1, k1) && this.blockAccess.getBlockId(i1 + 1, j1 + 1, k1) == Block.redstoneWire.blockID) {
				nw1.setColorOpaque_F(f1 * f3, f1 * f4, f1 * f5);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)(j1 + 0), (double)(k1 + 1), d2, d8);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 1), d4, d8);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 0), d4, d6);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)(j1 + 0), (double)(k1 + 0), d2, d6);
				nw1.setColorOpaque_F(f1, f1, f1);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)(j1 + 0), (double)(k1 + 1), d2, d8 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 1), d4, d8 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)(k1 + 0), d4, d6 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)((float)(i1 + 1) - 0.015625F), (double)(j1 + 0), (double)(k1 + 0), d2, d6 + 1.0D / 16.0D);
			}
			...
			if(this.blockAccess.isBlockNormalCube(i1, j1, k1 - 1) && this.blockAccess.getBlockId(i1, j1 + 1, k1 - 1) == Block.redstoneWire.blockID) {
				...
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)k1 + 0.015625F), d4, d8);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)k1 + 0.015625F), d4, d6);
				nw1.addVertexWithUV((double)(i1 + 0), (double)(j1 + 0), (double)((float)k1 + 0.015625F), d2, d6);
				nw1.setColorOpaque_F(f1, f1, f1);
				nw1.addVertexWithUV((double)(i1 + 1), (double)(j1 + 0), (double)((float)k1 + 0.015625F), d2, d8 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)k1 + 0.015625F), d4, d8 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)k1 + 0.015625F), d4, d6 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)(i1 + 0), (double)(j1 + 0), (double)((float)k1 + 0.015625F), d2, d6 + 1.0D / 16.0D);
			}

			if(this.blockAccess.isBlockNormalCube(i1, j1, k1 + 1) && this.blockAccess.getBlockId(i1, j1 + 1, k1 + 1) == Block.redstoneWire.blockID) {
				nw1.setColorOpaque_F(f1 * f3, f1 * f4, f1 * f5);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)(k1 + 1) - 0.015625F), d4, d6);
				...
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)(k1 + 1) - 0.015625F), d4, d8);
				nw1.setColorOpaque_F(f1, f1, f1);
				nw1.addVertexWithUV((double)(i1 + 1), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)(k1 + 1) - 0.015625F), d4, d6 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)(i1 + 1), (double)(j1 + 0), (double)((float)(k1 + 1) - 0.015625F), d2, d6 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)(i1 + 0), (double)(j1 + 0), (double)((float)(k1 + 1) - 0.015625F), d2, d8 + 1.0D / 16.0D);
				nw1.addVertexWithUV((double)(i1 + 0), (double)((float)(j1 + 1) + 7.0F / 320.0F), (double)((float)(k1 + 1) - 0.015625F), d4, d8 + 1.0D / 16.0D);
			}
		}
	...
	public boolean renderBlockCrops(Block uu1, int i1, int j1, int k1) {
		...
		float f1 = uu1.getBlockBrightness(this.blockAccess, i1, j1, k1);
		nw1.setColorOpaque_F(f1, f1, f1);
		this.func_1245_b(uu1, this.blockAccess.getBlockMetadata(i1, j1, k1), (double)i1, (double)j1 - 1.0D / 16.0D, (double)k1);
		return true;
	}
	...
	public void renderTorchAtAngle(Block uu1, double d1, double d2, double d3, double d4, double d5) {
		...
		double d6 = (double)f1 + 1.75D / 64.0D;
		double d7 = (double)f3 + 6.0D / 256.0D;
		double d8 = (double)f1 + 9.0D / 256.0D;
		double d9 = (double)f3 + 1.0D / 32.0D;
		d1 += 0.5D;
		d3 += 0.5D;
		double d10 = d1 - 0.5D;
		double d11 = d1 + 0.5D;
	...
	public boolean renderBlockFluids(Block uu1, int i1, int j1, int k1) {
		...
		if(!flag && !flag1 && !aflag[0] && !aflag[1] && !aflag[2] && !aflag[3]) {
			...
			if(this.renderAllFaces || flag1) {
				float var52 = uu1.getBlockBrightness(this.blockAccess, i1, j1 - 1, k1);
				nw1.setColorOpaque_F(f4 * var52, f4 * var52, f4 * var52);
			...
			for(k2 = 0; k2 < 4; ++k2) {
				...
				int var54 = uu1.getBlockTextureFromSideAndMetadata(k2 + 2, i2);
				int j4 = (var54 & 15) << 4;
				int var55 = var54 & 240;
				if(this.renderAllFaces || aflag[k2]) {
					...
					double d7 = (double)(((float)var55 + (1.0F - f14) * 16.0F) / 256.0F);
					double d8 = (double)(((float)var55 + (1.0F - f16) * 16.0F) / 256.0F);
					double d9 = ((double)(var55 + 16) - 0.01D) / 256.0D;
					float f23 = uu1.getBlockBrightness(this.blockAccess, var53, j1, l3);
					if(k2 < 2) {
						f23 *= f6;
					} else {
						f23 *= f7;
	...
	public boolean renderBlockFence(Block uu1, int i1, int j1, int k1) {
		...
		f1 = 7.0F / 16.0F;
		f2 = 9.0F / 16.0F;
		float f3 = 12.0F / 16.0F;
		float f4 = 15.0F / 16.0F;
