...
public class thModLoaderItemTool extends Item {
	private Block[] blocksEffectiveAgainst;
	private float efficiencyOnProperMaterial = 4.0F;
	private int damageVsEntity;
	protected thModLoaderListToolMaterial toolMaterial;

	protected thModLoaderItemTool(int var1, int var2, thModLoaderListToolMaterial var3, Block[] var4) {
		super(var1);
